...
from pubs.models import Pubs, Pizza, Ingredient, PubsIngredients, PizzaIngredients
                ...
                for store in stores:
                    ...
                    for pizza in pizza_list:
                        ...
                        for ingredient in pizza['ingredients']:
                            ...
                            db_store_ingredient = PubsIngredients.objects.filter(
                                store=db_store,
                            ...
                            if db_store_ingredient:
                                ...
                                db_store_ingredient = PubsIngredients(
                                    store=db_store,
                                    ingredient=db_ingredient,
